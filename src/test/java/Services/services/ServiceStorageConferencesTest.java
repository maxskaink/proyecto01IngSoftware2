...
class ServiceStorageConferencesTest {
    ...
    void createConference() {
        Conference con1 = new Conference("Derechoshumanos","Seinputan derecehos", new Date("26/11/2024") , new Date("26/12/2024"), "Cauca", "asd", 1,2 );
        ...
        //System.out.println(con2.getIdConference());
        System.out.println(con1.getIdConference());
