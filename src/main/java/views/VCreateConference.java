...
public class VCreateConference extends javax.swing.JFrame {
     ...
     */
    public VCreateConference(ServiceStorageConferences serviceConferences, int idOrganizer) {
        initComponents();
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Conference newConference = new Conference(name,  startDateFormatted, "d",finishDateFormatted, place, theme, 1, idOrganizer);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VCreateConference(serviceConferences, idOrganizer).setVisible(true);
            }
        });
    }
